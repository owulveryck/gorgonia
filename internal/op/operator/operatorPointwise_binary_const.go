...
var ʘBinOpDiffExprs = [maxʘBinaryOpType]func(x, y, z, gradZ *exprgraph.Node) (exprgraph.Nodes, error){
...
var ʘBinOpDiffFns = [maxʘBinaryOpType]func(ctx execution.Context, x, y, z *exprgraph.Node) error{
